...
export function JChToXYZ(jch, sp) {
  ...
  var t = Math.pow(
    C / (Math.sqrt(J / 100) * Math.pow(1.64 - Math.pow(0.29, sp.n), 0.73)),
    1 / 0.9
  );
  ...
  if (Math.abs(Math.sin(h)) >= Math.abs(Math.cos(h))) {
    ...
    b =
      ...
      1403 /
      (p4 +
        (2 + p3) * (220 / 1403) * (Math.cos(h) / Math.sin(h)) -
        27 / 1403 +
        (p3 * 6300) / 1403);
    ...
    a =
      ...
      (p5 +
        (2 + p3) * (220 / 1403) -
        (27 / 1403 - (p3 * 6300) / 1403) * (Math.sin(h) / Math.cos(h)));
  ...
  var RGBp = [
    Math.sign(RGBPa[0] - 0.1) *
      (100 / sp.FL) *
      Math.pow(
        (27.13 * Math.abs(RGBPa[0] - 0.1)) / (400 - Math.abs(RGBPa[0] - 0.1)),
        1 / 0.42
      ),
    Math.sign(RGBPa[1] - 0.1) *
      (100 / sp.FL) *
      Math.pow(
        (27.13 * Math.abs(RGBPa[1] - 0.1)) / (400 - Math.abs(RGBPa[1] - 0.1)),
        1 / 0.42
      ),
    Math.sign(RGBPa[2] - 0.1) *
      (100 / sp.FL) *
      Math.pow(
        (27.13 * Math.abs(RGBPa[2] - 0.1)) / (400 - Math.abs(RGBPa[2] - 0.1)),
        1 / 0.42
      ),
  ];
  ...
  var RGB = [RGBc[0] / sp.Dr, RGBc[1] / sp.Dg, RGBc[2] / sp.Db];
...
export function getSharedParameters() {
  ...
  var FL =
    ...
    0.1 * Math.pow(1 - Math.pow(k, 4), 2) * Math.pow(5 * LA, 1.0 / 3.0);
  ...
  var RGBPaw = [
    (400 * Math.pow((FL * RGBpw[0]) / 100, 0.42)) /
      (Math.pow((FL * RGBpw[0]) / 100, 0.42) + 27.13) +
      0.1,
    (400 * Math.pow((FL * RGBpw[1]) / 100, 0.42)) /
      (Math.pow((FL * RGBpw[1]) / 100, 0.42) + 27.13) +
      0.1,
    (400 * Math.pow((FL * RGBpw[2]) / 100, 0.42)) /
      (Math.pow((FL * RGBpw[2]) / 100, 0.42) + 27.13) +
      0.1,
  ];
...
export function xyzToJCh(XYZ, sp) {
  ...
  var RGBPa = [
    (400 * Math.pow((sp.FL * RGBp[0]) / 100, 0.42)) /
      (Math.pow((sp.FL * RGBp[0]) / 100, 0.42) + 27.13) +
      0.1,
    (400 * Math.pow((sp.FL * RGBp[1]) / 100, 0.42)) /
      (Math.pow((sp.FL * RGBp[1]) / 100, 0.42) + 27.13) +
      0.1,
    (400 * Math.pow((sp.FL * RGBp[2]) / 100, 0.42)) /
      (Math.pow((sp.FL * RGBp[2]) / 100, 0.42) + 27.13) +
      0.1,
  ];
  ...
  var t =
    ((50000 / 13) * sp.Nc * sp.Ncb * et * Math.sqrt(a * a + b * b)) /
